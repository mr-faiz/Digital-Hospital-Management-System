													...
													<table class="table table-striped table-bordered table-hover" id="sample_3" width="100%">
														...
														<tbody>
															<?php
																...
																$i=1;	
																$aFetch="SELECT * FROM tbl_doctor td, tbl_patient tp, tbl_appointment ta where ta.DoctorId=td.DOctorId and ta.PatientId=tp.PatientId ";
																$res1=$con->query($aFetch);
																if($res1==true)
																{
															...
															<tr class="odd gradeX">
																...
																<td class="center">
																	<a href="#" class="btn btn-danger" id="btnD" onclick="delFunction('<?php echo $row['AppointmentId']?>')" > <i class="fa fa-trash"></i></a> 
																</td>
															</tr>
															<?php
																	}
       ...
       <script src="../assets/global/plugins/jquery.min.js" type="text/javascript"></script>
        ...
        <script>
			...
			function delFunction(a)
			{
				...
				if(ans== true)
				{
					window.location="DeleteAppointment.php?aid="+a;
				}
				else{

										...
										<div class="portlet light portlet-fit portlet-datatable bordered">
											<div class="portlet-title">
												<div class="caption">
													...
													Room List / <span class="text-success bold"> <a href="AddBed.php" class="font-green"> + Add Room </a> </span> 
												</div>
												<div class="actions">
													<div class="btn-group">
											...
											<div class="portlet-body">
												<div class="table-container">
													<table class="table table-striped table-bordered table-hover" id="sample_3" width="100%">
														...
														<?php
															$i=1;	
															$room="select * from tbl_roomtype order by RTName";
															$res=$con->query($room);
															if($res==true)
															{
														...
														<tr class="odd gradeX">
															...
															<td> <?php echo $row['RTCode']; ?></td>
															<td> <?php echo $row['Price']; ?></td>
															<td class="center">
																 <a href="UpdateBed.php?roomid=<?php echo $row['RoomId'];?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
																
																<a href="#" class="btn btn-danger" id="btnD" onclick="delFunction('<?php echo $row['RoomId'];?>')" > <i class="fa fa-trash"></i></a> 
															</td>
														</tr>
														<?php
																}

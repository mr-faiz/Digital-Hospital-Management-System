										...
										<div class="portlet light portlet-fit portlet-datatable bordered">
											<div class="portlet-title">
												<div class="caption">
													...
													Department List / <span class="text-success bold"> <a href="AddDepartment.php" class="font-green"> + Add Department </a> </span> 
												</div>
												<div class="actions">
													<div class="btn-group">
													...
													<table class="table table-striped table-bordered table-hover" id="sample_3" width="100%">
														...
														<tbody>
															...
															<tr class="odd gradeX">
																...
																<td class="center">
																	<a href="UpdateDepartment.php?id=<?php echo $row['DeptId'];?>" class="btn btn-success"><i class="fa fa-pencil"></i></a> 
																	<a href="#" class="btn btn-danger" id="btnD" onclick="delFunction('<?php echo $row['DeptId']?>')" > <i class="fa fa-trash"></i></a> 
																</td>
															</tr>
															<?php
																	}
       ...
       <script src="../assets/global/plugins/jquery.min.js" type="text/javascript"></script>
        ...
        <script>
			...
			function delFunction(a)
			{
				...
				if(ans== true)
				{
					window.location="DeleteDepartment.php?id="+a;
				}
				else{
